...
introscope.autoprobe.directivesFile=<%= @jboss_directivesFiles %>
...
# JMX filter for JBoss 6 and previous vrsions.
...
# JMX filter for JBoss 7 at a minimum
...
introscope.agent.leakhunter.ignore.12=<%= @leakhunter_ignore_12 %>
