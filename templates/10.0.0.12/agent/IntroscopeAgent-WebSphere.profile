...
introscope.autoprobe.enable=<%= @autoprobe_enable %>
...
introscope.autoprobe.logfile=<%= @logs_dir %>/AutoProbe.log
...
introscope.autoprobe.directivesFile=<%= @websphere_directivesFiles %>
...
introscope.agent.dns.lookup.type=<%= @dns_lookup_type %>
#
...
introscope.agent.dns.lookup.max.wait.in.milliseconds=<%= @dns_lookup_max_wait %>
...
# You must restart the managed application before changes to this property take effect.
introscope.agent.agentAutoNamingEnabled=<%= @agentAutoNamingEnabled %>
...
# You must restart the managed application before changes to this property take effect.
introscope.agent.disableLogFileAutoNaming=<%= @disableLogFileAutoNaming %>
...
introscope.agent.extensions.directory=<% @agent_extensions_directory %>
...
#introscope.agent.extensions.eagerloader=<%= @extensions_eagerLoader %>
...
introscope.agent.common.directory=<% @agent_common_directory %>
...
#introscope.agent.thread.all.priority=<% @agent_thread_all_priority %>
...
introscope.agent.clonedAgent=<% @agent_clonedAgent %>
...
#introscope.agent.platform.monitor.system=<%= @agent_platform_monitor_system %>
...
# You must restart the managed application before changes to this property take effect.
introscope.agent.pmi.enable=<%= @pmi_enable %>
...
# is a numeric string
# You must restart the managed application before changes to this property take effect.
introscope.agent.pmi.filter.objref=<%= @pmi_filter_objRef %>
...
# You must restart the managed application before changes to this property take effect.
introscope.agent.pmi.enable.threadPoolModule=<%= @pmi_enable_threadPoolModule %>
introscope.agent.pmi.enable.servletSessionsModule=<%= @pmi_enable_servletSessionsModule %>
introscope.agent.pmi.enable.connectionPoolModule=<%= @pmi_enable_connectionPoolModule %>
introscope.agent.pmi.enable.beanModule=<%= @pmi_enable_beanModule %>
introscope.agent.pmi.enable.transactionModule=<%= @pmi_enable_transactionModule %>
introscope.agent.pmi.enable.webAppModule=<%= @pmi_enable_webAppModule %>
introscope.agent.pmi.enable.jvmRuntimeModule=<%= @pmi_enable_jvmRuntimeModule %>
introscope.agent.pmi.enable.systemModule=<%= @pmi_enable_systemModule %>
introscope.agent.pmi.enable.cacheModule=<%= @pmi_enable_cacheModule %>
introscope.agent.pmi.enable.orbPerfModule=<%= @pmi_enable_orbPerfModule %>
introscope.agent.pmi.enable.j2cModule=<%= @pmi_enable_j2cModule %>
introscope.agent.pmi.enable.webServicesModule=<%= @pmi_enable_webServicesModule %>
introscope.agent.pmi.enable.wlmModule=<%= @pmi_enable_wlmModule %>
introscope.agent.pmi.enable.wsgwModule=<%= @pmi_enable_wsgwModule %>
introscope.agent.pmi.enable.alarmManagerModule=<%= @pmi_enable_alarmManagerModule %>
introscope.agent.pmi.enable.hamanagerModule=<%= @pmi_enable_hamanagerModule %>
introscope.agent.pmi.enable.objectPoolModule=<%= @pmi_enable_objectPoolModule %>
introscope.agent.pmi.enable.schedulerModule=<%= @pmi_enable_schedulerModule %>
introscope.agent.pmi.enable.jvmpiModule=<%= @pmi_enable_jvmpiModule %>
introscope.agent.pmi.enable.SIB\ Service=<%= @pmi_enable_SIB_Service %>

# PMI properties for Websphere Process Server
introscope.agent.pmi.enable.WBIStats.RootGroup=<%= @pmi_enable_WBIStats_RootGroup %>
introscope.agent.pmi.enable.SCAStats.RootGroup=<%= @pmi_enable_SCAStats_RootGroup %>
...
introscope.agent.jmx.enable=<%= @jmx_enable %>

# JMX metrics polling interval;
# Set to true to change the polling interval to 15 seconds; default is false (7.5 seconds)

introscope.agent.jmx.maxpollingduration.enable=<%= @jmx_maxpollingduration_enable %>
...
introscope.agent.jmx.ratecounter.enable=<%= @jmx_ratecounter_enable %>
...
introscope.agent.jmx.ratecounter.reset.enable=<%= @jmx_ratecounter_reset_enable %>
...
introscope.agent.jmx.compositedata.enable=<%= @jmx_compositedata_enable %>

##############
# JSR 77 Support
#
# This group of properties enables and configures support for JSR-77 Management Metrics. JSR-77 Management support
# must be provided by the Application Server in order for these options to have any effect.
#
#
...
#		REQUIRED: uncomment the property - introscope.agent.jmx.name.primarykeys
#		OPTIONAL: introscope.agent.jmx.ignore.attributes=
#
##############
# You must restart the managed application before changes to this property take effect.

introscope.agent.jmx.name.jsr77.disable=<%= @jsr77_disable %>
...
#introscope.agent.jmx.name.primarykeys=<%= @jmx_name_primarykeys_websphere %>
...
introscope.agent.jmx.name.filter=<%= @jmx_name_filter_websphere %>
...
introscope.agent.jmx.ignore.attributes=<%= @jmx_ignore_attributes %>
...
# You must restart the managed application before changes to this property take effect.
introscope.agent.jmx.excludeStringMetrics=<%= @jmx_exclude_string_metrics %>
...
introscope.agent.leakhunter.enable=<%= @leakhunter_enable %>
...
introscope.agent.leakhunter.logfile.location=<%= @logs_dir %>/LeakHunter.log
...
introscope.agent.leakhunter.leakSensitivity=<%= @leakhunter_leakSensitivity %>
...
introscope.agent.leakhunter.timeoutInMinutes=<%= @leakhunter_timeout %>
...
# Changes to this property take effect immediately and do not require the managed application to be restarted.
introscope.agent.leakhunter.collectAllocationStackTraces=<%= @leakhunter_collectAllocationStackTraces %>
...
<% @leakhunter_ignore_on_websphere.to_enum.each_with_index do |val, idx| -%>
...
introscope.agent.sqlagent.sql.turnoffmetrics=<%= @sqlagent_turnoffmetrics %>

# Report only Average Response Time metric for individual SQL statements. The default value is false.
introscope.agent.sqlagent.sql.artonly=<%= @sqlagent_artonly %>

# Turn off transaction tracing for individual sql statements. The default value is false.
introscope.agent.sqlagent.sql.turnofftrace=<%= @sqlagent_turnofftrace %>
...
introscope.agent.sqlagent.sql.rawsql=<%= @sqlagent_rawsql %>
...
introscope.agent.sqlagent.normalizer.extension=<%= @sqlagent_normalizer_extension %>
...
# Changes to this property take effect immediately and do not 
# require the managed application to be restarted.
introscope.agent.sqlagent.normalizer.regex.keys=<%= @sqlagent_normalizer_regex_keys %>
...
introscope.agent.sqlagent.normalizer.regex.key1.pattern=<%= @sqlagent_normalizer_regex_key1_pattern %>
...
# require the managed application to be restarted.
# Default value is 'false'
introscope.agent.sqlagent.normalizer.regex.key1.replaceAll=<%= @sqlagent_normalizer_regex_key1_replaceAll %>
...
# Changes to this property take effect immediately and do not 
# require the managed application to be restarted.
introscope.agent.sqlagent.normalizer.regex.key1.replaceFormat=<%= @sqlagent_normalizer_regex_key1_replaceFormat %>

# This property specifies whether the pattern match is sensitive to case
# Changes to this property take effect immediately and do not 
# require the managed application to be restarted.
introscope.agent.sqlagent.normalizer.regex.key1.caseSensitive=<%= @sqlagent_normalizer_regex_key1_caseSensitive %>
...
introscope.agent.crossprocess.compression=<%= @crossprocess_compression %>
# Minimum length of cross process parameter data length for which to apply compression
introscope.agent.crossprocess.compression.minlimit=<%= @crossprocess_compression_minlimit %>
...
# Changes to this property take effect immediately and do not require the managed application to be restarted.
introscope.agent.urlgroup.keys=<%= @urlgroup_keys %>
...
# Changes to this property take effect immediately and do not require the managed application to be restarted.
introscope.agent.errorsnapshots.enable=<%= @errorsnapshots_enable %>

# The following setting configures the maximum number of error snapshots
# that the Agent can send in a 15-second period.
# Changes to this property take effect immediately and do not require the managed application to be restarted.
introscope.agent.errorsnapshots.throttle=<%= @errorsnapshots_throttle %>
...
# Changes to this property take effect immediately and do not require the managed application to be restarted.
introscope.agent.stalls.resolutionseconds=<%= @stalls_resolutionseconds %>
...
# You must restart the managed application before changes to this property take effect.
introscope.autoprobe.deepinheritance.enabled=<%= @autoprobe_deepinheritance_enabled %>
...
# Changes to this property take effect immediately and do not require the managed application to be restarted.
introscope.agent.metricAging.dataChunk=<%= @metricAging_dataChunk %>
#
...
# Changes to this property take effect immediately and do not require the managed application to be restarted.
introscope.agent.metricAging.numberTimeslices=<%= @metricAging_numberTimeslices %>
#
# You can choose to ignore metrics from removal by adding the metric name or metric filter to the list below.  
# Changes to this property take effect immediately and do not require the managed application to be restarted.
#introscope.agent.metricAging.metricExclude.ignore.0=<%= @metricAging_exclude_for_websphere[0] %>

# To ignore ChangeDetector.AgentID  metric from metric aging.
#introscope.agent.metricAging.metricExclude.ignore.1=<%= @metricAging_exclude_for_websphere[1] %>

<% @metricAging_exclude_for_websphere.to_enum.each_with_index do |val, idx| -%>
...
# You must restart the managed application before changes to this property take effect.
introscope.changeDetector.enable=<%= @changeDetector_enable %>
#######################
# Root directory 
#
# ================
...
introscope.agent.appmap.enabled=<%= @appmap_enabled %>
...
#unbounded. 
introscope.agent.appmap.queue.size=<%= @appmap_queue_size %>
...
introscope.agent.appmap.queue.period=<%= @appmap_queue_period %>
...
introscope.agent.appmap.levels.enabled=<%= @appmap_levels_enabled %>
...
introscope.agent.appmap.owners.enabled=<%= @appmap_owners_enabled %>
...
#Default value true
introscope.agent.sockets.managed.reportToAppmap=<%= @appmap_sockets_managed_reportToAppmap %>

#Enables Managed sockets to report Class level application edge to Application map
#Default value false
introscope.agent.sockets.managed.reportClassAppEdge=<%= @appmap_sockets_managed_reportClassAppEdge %>


#Enables Managed sockets to report Method level application edge to Application map
#Default value true
introscope.agent.sockets.managed.reportMethodAppEdge=<%= @appmap_sockets_managed_reportMethodAppEdge %>
...
#Default value true
introscope.agent.sockets.managed.reportMethodBTEdge=<%= @appmap_sockets_managed_reportMethodBTEdge %>
...
# You must restart the managed application before changes to this property take effect.
introscope.agent.bizRecording.enabled=<%= @bizRecording_enabled %>
#
...
#
# ================
# Specify the tracethreshold property value.
introscope.agent.siteminderwebagent.tracethreshold=<%= @siteMinder_webAgent_traceThreshold %>
...
com.wily.introscope.agent.blame.transaction.doTransactionTrace=<%= @blame_transaction_doTransactionTrace %>
...
# The default value is true.
# You must restart the managed application before changes to this property take effect
introscope.agent.deep.instrumentation.enabled=<%= @deep_instrumentation_enabled %>
...
introscope.agent.deep.trace.enabled=<%= @deep_trace_enabled %>
...
# Change to this property takes effect immediately and does not require the 
# managed application to be restarted.
introscope.agent.deep.instrumentation.level=<%= @deep_instrumentation_level %>
...
# Change to this property takes effect immediately and does not require the 
# managed application to be restarted.
introscope.agent.deep.instrumentation.level.batch.size=<%= @deep_instrumentation_level_batch_size %>
...
# Change to this property takes effect immediately and does not require the 
# managed application to be restarted.
introscope.agent.deep.instrumentation.level.batch.interval=<%= @deep_instrumentation_level_batch_interval %>
...
# You must restart the managed application before changes to this property take effect
introscope.agent.deep.instrumentation.max.methods=<%= @deep_instrumentation_max_methods %>

# This property limits the maximum number of deep trace components in a Transaction Trace
# Change to this property takes effect immediately and does not require the 
# managed application to be restarted.
introscope.agent.deep.trace.max.components=<%= @deep_trace_max_components %>

# This property limits the maximum number of consecutive deep trace components in a Transaction Trace
# Change to this property takes effect immediately and does not require the 
# managed application to be restarted.
introscope.agent.deep.trace.max.consecutive.components=<%= @deep_trace_max_consecutive_components %>

#Set of package prefixes that should be scored low as they're unlikely to be relevant to transactions
# You must restart the managed application before changes to this property take effect
introscope.agent.deep.instrumentation.custom.prefixes=<%= @deep_instrumentation_custom_prefixes %>
...
# Change to this property takes effect immediately and does not require the 
# managed application to be restarted.
introscope.agent.deep.automatic.trace.enabled=<%= @deep_automatic_trace_enabled %>

# Clamps the number of automatic traces collected by Introscope per 1 minute interval. 
# Note: does not apply to sampled transaction traces.
# Change to this property takes effect immediately and does not require the 
# managed application to be restarted.
introscope.agent.deep.automatic.trace.clamp=<%= @deep_automatic_trace_clamp %>
...
# managed application to be restarted.
# The default value is true.
introscope.agent.external.biz.enabled=<%= @external_biz_enable %>
...
introscope.agent.external.biz.header.size.max=<%= @external_biz_header_size_max %>

# Maximum number of External Business Transactions allowed.
# Changes to this property take effect immediately and do not require the 
# managed application to be restarted.
# The default value is 100.
introscope.agent.external.biz.bt.count.max=<%= @external_biz_bt_count_max %>
