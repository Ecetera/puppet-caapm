...
introscope.autoprobe.directivesFile=<%= @btrm_directivesFiles %>
...
#introscope.agent.metricAging.metricExclude.ignore.X+1=ChangeDetector.AgentID
#Note: Here X is the existing sequence number for the introscope.agent.metricAging.metricExclude.ignore property of the IntroscopeAgent.profile file.
